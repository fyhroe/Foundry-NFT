...
This repository is part of the Cyfrin Foundry Solidity Course, specifically focused on building and testing NFT smart contracts using Foundry. It showcases how to build both IPFS-hosted NFTs and on-chain SVG NFTs using the ERC-721 standard.
